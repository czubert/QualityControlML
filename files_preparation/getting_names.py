...
#path = 'data_input/*/*/*/*'  # For data with strange long names starting with S28.234...
new_data_url = 'data_input/'
new_ag_url = new_data_url + 'PMBA/*/*/*'
new_ag_bg_url = new_data_url + 'BG/*/*/*'
