...
def main():
    ...
    st.subheader('Preset dimensions of our substrates')
    substr_type = {'premium': 'Premium SERSitive Substrates', 'Stype': 'S-Type SERSitive Substrates'}
    chosen_substr_type = st.radio('What type of substrates did you use?', substr_type, format_func=substr_type.get)
    ...
    if chosen_substr_type == 'premium':
        volume = 2000.0
    else:
        volume = 200.0
        
    volume = ef_utils.get_volume(volume)
